...
Widget::Widget( Area2D& size, const RGBA& color, LayoutSolver* solver)
{
    mSize = size;
    mColor = color;
    mLayerDepth = 0;
...
Widget::Widget( Widget* parent, Area2D& size, PixelPadding& padding, const RGBA& color, LayoutSolver* solver, LayoutType layoutType /*= WIDGET_LAYOUT_STREAM*/ )
{
    mSize = size;
    mPadding = padding;
    mLayerDepth = 0;
...
void Widget::onLayoutChanged( GUIEvent& evt )
{
